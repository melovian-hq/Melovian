...
func (h *LyricsHandler) handleWhisperTrackLyrics(w http.ResponseWriter, r *http.Request) {
	if !extensions.IsEnabled(h.cfg.DataDir, lyricsWhisperExtensionID) {
	...
	if strings.HasPrefix(contentType, "application/json") {
		doc, err = h.whisperFromSegments(r, in)
	} else {
		doc, err = h.whisperFromAudio(w, r, in, settings)
	}
	if err != nil {
...
func (h *LyricsHandler) whisperFromSegments(r *http.Request, in lyrics.FetchInput) (*lyrics.Document, error) {
...
func (h *LyricsHandler) whisperFromAudio(w http.ResponseWriter, r *http.Request, in lyrics.FetchInput, settings LyricsSettings) (*lyrics.Document, error) {
