...
const ACTION_COMMANDS: PaletteCommand[] = [
  ...
  {
    id: "random-radio",
    label: "Play random radio",
    group: "Playback",
    icon: "radio",
    keywords: ["radio", "random", "continuous", "refill"],
    run: () => void music.playRandomRadio(),
  },
  {
    id: "personal-radio",
    label: "Play personal radio",
    group: "Playback",
    icon: "radio",
    keywords: ["radio", "personal", "continuous", "refill"],
